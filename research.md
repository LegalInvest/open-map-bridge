...
| Git 仓库 | GitHub main `873705b`；当前证据分支 `codex/audit-p1-import-resource-bounds-evidence` 基于该提交，remote 为 `https://github.com/LegalInvest/open-map-bridge.git` | `git branch --show-current`、`git rev-parse HEAD origin/main`、`git remote -v`、PR #13 | 2026-08-28 19:15 |
...
| 审计问题账本 | 161 个 tracked files 静态审计形成 38 组问题与公开 backlog；前七批已进 main，第七批限制导入非可信输入资源并保留首次红灯 | FIX-BATCH-001/002/003/004/005/006/007 main / remaining discovered | `docs/问题账本.md`、PR #1/#3/#5/#7/#9/#11/#13、CI `33166313733`；2026-08-28 19:15 |
