...
export const QR_IMAGE_PREPROCESS_MAX_PIXELS = 16 * 1024 * 1024;

export const QR_IMAGE_PREPROCESS_SCALES = [2, 3] as const;

export const IMPORT_PREVIEW_MAX_ENTRIES = 64;

export const IMPORT_PREVIEW_MAX_BYTES = 4 * 1024 * 1024;
