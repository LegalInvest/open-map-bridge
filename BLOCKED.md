...
10. 全量审计：`docs/问题账本.md` 记录 38 组问题。`FIX-BATCH-001/002/003/004/005` 已进入 main；001/003/004/005/020/021/022/023 达到 main，002 仅假绿和解码前置子项达到 main。PR #9 首次红灯 `33164557423` 已保留，第二次 CI `33164783702` 全绿并合并为 `f84ae20`；其余不得因五批合并而标记解决。
