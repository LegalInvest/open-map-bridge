...
- `last_updated_at`: `2026-09-01T00:49:31.152+08:00`
- `basis_commit`: `4730395d3e95`
- `source_fingerprint_sha256`: `a7ea0efda95aca40b2f65dd30cfc17fb7a15a5b7180b91a664dc309b2c09cfe0`
- `status`: `持续更新中的技术事实稿`
...
该实现当前仅为 `local-candidate`：本机只高于 8 GiB 硬门约 78 MiB，未运行 test/typecheck/build/browser，必须由 GitHub PR CI 验证；腾讯 current 仍为 `3bbcbfa`，没有真实 Ovi ProbeResult、真实渲染或用户验收。阶段 B 的 scheme/非秘密常量 query 真值仍保持开放，不能被阶段 A 候选绕过。
